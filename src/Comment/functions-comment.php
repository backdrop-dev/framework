...
function hierarchy() {
	...
	return apply_filters( 'backdrop/comment/hierarchy', $hier );
}
...
function render_author( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/author', $args['before'] . $html . $args['after'] );
}
...
function render_author_link( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/author/link', $args['before'] . $html . $args['after'] );
}
...
function render_permalink( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/permalink', $args['before'] . $html . $args['after'] );
}
...
function render_date( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/date', $args['before'] . $html . $args['after'] );
}
...
function render_time( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/time', $args['before'] . $html . $args['after'] );
}
...
function render_edit_link( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/edit_link', $html );
}
...
function render_reply_link( array $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/reply_link', $html );
}
...
function render_parent_link( $args = [] ) {
	...
	return apply_filters( 'backdrop/comment/parent_link', $html, $args );
}
